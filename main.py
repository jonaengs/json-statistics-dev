...
if __name__ == '__main__':
    ...
    parser.add_argument("-n", "--new", dest="logger-force_new", action="store_true", help="Force creation of fresh statistics")
    ...
    if "stats-stat_type" in args and getattr(args, "stats-stat_type") is not None: 
